...
import com.alpha.mymemories.databinding.ActivityMainBinding
import com.alpha.mymemories.databinding.CameraBinding
...
public class MainCamera : AppCompatActivity() {
    ...
    private fun captureVideo() {
        ...
        recording = videoCapture.output
            ...
            .apply {
                if (PermissionChecker.checkSelfPermission(this@MainCamera,
